 ...
 public void setParameter(int instance, double crossoverRate, double mutationRate, int counter,
  ...
  public String start(){
    ...
    String Result = "\t"+DEFAULT_crossoverRate+"\t"+DEFAULT_mutationRate+"\t"+
            elitism+"\n"+ "距離:" +GaMain.getArchieve().getSingleChromosome(0).getObjValue()[0]+"\n"+ "執行時間:" +timeClock1.getExecutionTime()/1000.0 +"\n走訪順序:" + GaMain.getArchieve().getSingleChromosome(0).toString1() + "\t" ;
    return Result;
