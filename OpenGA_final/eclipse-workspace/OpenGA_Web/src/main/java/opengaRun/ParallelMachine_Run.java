...
public class ParallelMachine_Run {
  public ParallelMachine_Run() {
  }
  ...
  public void tran(int crossrate, int mutarate, int generations, int yn, int elitism){
      this.DEFAULT_crossoverRate = (double) crossrate / 100;
      this.DEFAULT_mutationRate  = (double) mutarate  / 100;
      this.DEFAULT_generations   = generations;
      this.elitism               = (double)elitism    / 100;
  ...
  public static void main(String[] args) {
    ...
    flowshopParallelMachine1.tran(90, 50, 1000, 1, 20);
