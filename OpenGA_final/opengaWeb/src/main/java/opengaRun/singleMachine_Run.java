...
public class singleMachine_Run {
  public singleMachine_Run() {
  }
  ...
  public String startMain(){
    ...
    String Result;
    Result = "runtime:" + timeClock1.getExecutionTime()/1000.0+"\n<br>" + "result:" + GaMain.getArchieve().getSingleChromosome(bestInd).toString1();
    return Result;
  }
