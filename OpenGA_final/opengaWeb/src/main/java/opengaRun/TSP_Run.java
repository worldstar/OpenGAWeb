 ...
 public void setParameter(int instance, double crossoverRate, double mutationRate, int counter,
  ...
  public String start(){
    ...
    String implementResult = instanceName+"\t"+DEFAULT_crossoverRate+"\t"+DEFAULT_mutationRate+"\t"+
        ...
        +"\t" + GaMain.getArchieve().getSingleChromosome(0).toString1() + "\t" +timeClock1.getExecutionTime()/1000.0+"\n";
    writeFile("TSP_SGA1010DOE", implementResult);
    System.out.print(implementResult);
    String Result = "\t"+DEFAULT_crossoverRate+"\t"+DEFAULT_mutationRate+"\t"+
            elitism+"\n<br>"+ "distance:" +GaMain.getArchieve().getSingleChromosome(0).getObjValue()[0]+"\n<br>"+ "runtime:" +timeClock1.getExecutionTime()/1000.0 +"\n<br>" + "visit order:" + GaMain.getArchieve().getSingleChromosome(0).toString1() + "\t" ;
    return Result;
...
//	        double distanceMatrix[][] = TSPInstances1.getDistanceMatrix();
//	        for(int a=0;a<10;i++) {
//	        	for(int b=0;b<10;b++) {
